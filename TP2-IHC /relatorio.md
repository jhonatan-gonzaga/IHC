...
Como podemos ver na tabela presente na seção 5.1, todos os algoritmos, com a exceção do ZeroR, apresentaram acurácias perfeitas, tendo 100% de acertos nas suas previsões para a parte da base de dados destinada a sua avaliação. No caso do algoritmo ZeroR, tal algoritmo apresentou 50% de acerto já que metade da base de dados tem como classificação "Progredindo" (100 instâncias) e a outra metade é classificada como "Com dificuldade" (novamente, 100 instâncias). Ou seja, o algoritmo apenas verificou qual era a classe alvo com maior quantidade de instâncias, que neste caso pode ser as duas, e presumiu que todas seriam daquela classe alvo.
