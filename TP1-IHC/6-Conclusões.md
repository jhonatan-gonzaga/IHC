...
As aulas de IHC foram essenciais pois com a ajuda do Prof Andrey, minhas ideais foram se juntando a cada dúvida. Os desafios vinheram a cada avaliação pedida, a identificação das heuristicas do aplicativo LibreOffice Calc, percebemos cada erro e falhas do aplicativo, utilizamos isso a nosso favor  
